...
## 1:10 - 2:00: Agent Recommendation
...
## 2:00 - 3:10: Execution Preparation
...
## 3:10 - 3:40: Wallet Boundary

Connect wallet if available. Try **Sign approval only** and **Sign swap only**. Explain that wallet support may vary, but CircuitStock never broadcasts automatically.
